...
///
/// Raw speech output often contains fillers, missing punctuation, and false starts. Keeping
/// cleanup behind this contract lets Mumble offer deterministic and on-device model passes.
